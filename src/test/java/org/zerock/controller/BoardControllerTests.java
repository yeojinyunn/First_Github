...
public class BoardControllerTests {
   ...
   private WebApplicationContext ctx;
      // MockMvc는 "가짜 mvc"라고 생각하면 됩니다. 가짜로 URL과 파라미터 등을 브라우저에서 Moc:가짜
...
//	   String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/register").param("title", "테스트 새글 제목").param("content", "테스트 새글 내용").param("writer", "봉미선")).andReturn().getModelAndView().getViewName();
//	   log.info(resultPage);
//   }
//   
//   @Test
